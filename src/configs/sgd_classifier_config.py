...
def sgd_classifier_config() -> argparse.Namespace:
    ...
    p.add_argument("--loss", type=str, default="log_loss", choices=["squared_hinge", "modified_huber", "epsilon_insensitive", "hinge", "squared_error", "huber", "squared_epsilon_insensitive", "perceptron", "log_loss"])
