...
def extra_tree_classifier_config() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="extra_tree_classifier")
...
def extra_tree_regressor_config() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="extra_tree_regressor")
