...
def lightgbm_classifier_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="lightgbm_classifier")
...
def lightgbm_regressor_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="lightgbm_regressor")
